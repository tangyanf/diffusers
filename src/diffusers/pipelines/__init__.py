...
try:
    ...
    _import_structure["joyimage"] = ["JoyImageDMDPipeline", "JoyImageEditPipeline", "JoyImageEditPipelineOutput", "JoyImageEditPlusPipeline", "JoyImageEditPlusPipelineOutput", "JoyImagePipeline", "JoyImagePipelineOutput"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .joyimage import JoyImageDMDPipeline, JoyImageEditPipeline, JoyImageEditPipelineOutput, JoyImageEditPlusPipeline, JoyImageEditPlusPipelineOutput, JoyImagePipeline, JoyImagePipelineOutput
